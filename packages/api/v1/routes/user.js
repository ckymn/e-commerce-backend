...
//user_get
const user_auth = require("../controllers/user/auth/router");
const user_comment = require("../controllers/user/comment/router");
const user_profile = require("../controllers/user/profile/router");
const user_home = require("../controllers/user/user_home/router");
const user_follow = require("../controllers/user/follow/rotuer");
...
router.post(
  "/user/product_comment/:id",
  idChecker(),
  authJwt,
  user_comment.add_product_comment
);
router.delete(
  "/user/product_comment/:id",
  idChecker(),
  authJwt,
  user_comment.delete_product_comment
);
router.put(
  "/user/product_comment/:id",
  idChecker(),
  authJwt,
  user_comment.update_product_comment
);
router.post(
  "/user/store_follow/:id",
  idChecker(),
  authJwt,
  user_follow.store_follow
);
router.delete(
  "/user/store_unfollow/:id",
  idChecker(),
  authJwt,
  user_follow.store_unfollow
);
router.post(
  "/user/product_favorite/:id",
  idChecker(),
  authJwt,
